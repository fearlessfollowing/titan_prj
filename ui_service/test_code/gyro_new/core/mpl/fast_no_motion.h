...
extern "C" {
    ...
    inv_error_t inv_update_fast_nomot(int *gyro);

    void inv_get_fast_nomot_accel_param(int *cntr, long long *param);
    void inv_get_fast_nomot_compass_param(int *cntr, long long *param);
