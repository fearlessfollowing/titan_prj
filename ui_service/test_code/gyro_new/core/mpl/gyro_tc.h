...
inv_error_t inv_get_gyro_ts(int *data);
inv_error_t inv_set_gyro_ts(int *data);

inv_error_t inv_init_gyro_ts(void);

inv_error_t inv_set_gtc_max_temp(int data);
inv_error_t inv_set_gtc_min_temp(int data);
