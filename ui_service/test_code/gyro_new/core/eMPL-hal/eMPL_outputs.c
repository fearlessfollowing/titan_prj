 ...
 */
int inv_get_sensor_type_accel(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_gyro(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_compass(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_quat(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
...
#ifdef ENABLE_DEBUG
    printf("eMPL_out.quat %d %d %d %d "
                   "eMPL_out.quat_accuracy 0x%x "
                   "ts %llu status 0x%x\n",
           eMPL_out.quat[0],eMPL_out.quat[1],
           eMPL_out.quat[2],eMPL_out.quat[3],
           eMPL_out.quat_accuracy,
           eMPL_out.nine_axis_timestamp,
           eMPL_out.nine_axis_status);
#endif
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_heading(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
    int t1, t2, q00, q03, q12, q22;
    float fdata;
 ...
 *  @return     1 if data was updated.
 */
int inv_get_sensor_type_euler(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
    int t1, t2, t3;
    int q00, q01, q02, q03, q11, q12, q13, q22, q23, q33;
    float values[3];
    ...
    if (values[1] < -90)
        values[1] = -180 - values[1];
    data[0] = (int)(values[0] * 65536.f);
    data[1] = (int)(values[1] * 65536.f);
    data[2] = (int)(values[2] * 65536.f);
 ...
 *  @return     1 if data was updated.
 */
int inv_get_sensor_type_rot_mat(int *data, int8_t *accuracy, inv_time_t *timestamp)
{
...
//    printf("inv_generate_eMPL_outputs start use_sensor 0x%x\n",use_sensor);
    switch (use_sensor) {
    default:
    case 0:
