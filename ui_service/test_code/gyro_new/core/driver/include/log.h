...
#ifdef __KERNEL__
#define MPL_LOG_UNKNOWN MPL_ANDROID_LOG_VERBOSE
#define MPL_LOG_DEFAULT KERN_DEFAULT
#define MPL_ANDROID_LOG_VERBOSE KERN_CONT
#define MPL_ANDROID_LOG_DEBUG   KERN_NOTICE
#define MPL_LOG_INFO    KERN_INFO
#define MPL_LOG_WARN    KERN_WARNING
#define MPL_LOG_ERROR   KERN_ERR
#define MPL_LOG_SILENT  MPL_ANDROID_LOG_VERBOSE
...
#define MPL_ANDROID_LOG_VERBOSE		(2)
#define MPL_ANDROID_LOG_DEBUG		(3)
...
#define MPL_LOGV(fmt, ...)						\
	do {								\
		...
		if (0)							\
			MPL_LOG(ANDROID_LOG_VERBOSE, MPL_LOG_TAG, fmt, ##__VA_ARGS__);\
            __pragma (warning(suppress : 4127 )) \
    } while (0)
#else
#define MPL_LOGV(fmt, ...)						\
...
#else
#define MPL_LOGV(fmt, ...) MPL_LOG(ANDROID_LOG_VERBOSE, MPL_LOG_TAG, fmt, ##__VA_ARGS__)
#endif
#endif
 ...
 */
#ifndef MPL_LOGD
#define MPL_LOGD(fmt, ...) MPL_LOG(ANDROID_LOG_DEBUG, MPL_LOG_TAG, fmt, ##__VA_ARGS__)
#endif

#ifndef MPL_LOGD_IF
#define MPL_LOGD_IF(cond, fmt, ...) \
	((CONDITION(cond))					       \
		? MPL_LOG(ANDROID_LOG_DEBUG, MPL_LOG_TAG, fmt, ##__VA_ARGS__)  \
		: (void)0)
#endif
...
#else
#define MPL_LOGI(fmt, ...) MPL_LOG(ANDROID_LOG_INFO, MPL_LOG_TAG, fmt, ##__VA_ARGS__)
#endif
#endif
...
#define MPL_LOGI_IF(cond, fmt, ...) \
	((CONDITION(cond))                                              \
		? MPL_LOG(ANDROID_LOG_INFO, MPL_LOG_TAG, fmt, ##__VA_ARGS__)   \
		: (void)0)
#endif
...
#else
#define MPL_LOGW(fmt, ...) MPL_LOG(ANDROID_LOG_WARN, MPL_LOG_TAG, fmt, ##__VA_ARGS__)
#endif
#endif
...
#else
#define MPL_LOGE(fmt, ...) MPL_LOG(ANDROID_LOG_ERROR, MPL_LOG_TAG, fmt, ##__VA_ARGS__)
#endif
#endif
